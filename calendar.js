...
Calendar.prototype.create = function (_par) {
	...
	cell = Calendar.createElement("td", row);
	cell.className = "timebutton";
	cell.innerHTML = "<div unselectable='off'>&nbsp;</div>";
...
Calendar.prototype.callHandler = function () {
	if (this.onSelected) {
		...
		/**** newly added line *********/	
	  convertedDate = formatDate(this.date,'y-MM-d H:mm');  
 
  
		this.onSelected(this, this.date.print(this.dateFormat),convertedDate);		
	}
};
